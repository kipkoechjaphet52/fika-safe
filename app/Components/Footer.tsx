    ...
    <footer className="py-8 px-4 ">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <Link href="/" className="flex items-center space-x-2 md:mb-4">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 border-t border-gray-200">
            ...
            <div className="pt-4 flex space-x-10 justify-between md:ml-4 md:mr-64 saturate-0">
